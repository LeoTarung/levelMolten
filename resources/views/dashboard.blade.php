        ...
        <div class="row align-items-start mt-3">
            <div class="col-3">
                <div class="card card-rounded card-back shadow">
                    ...
                    <div class="card-header bg-warning rounded-top fw-bold fs-15 text-center">Mesin :
                        {{ $molt1['mc'] }}
                    </div>
            ...
            <div class="col-3">
                <div class="card card-rounded card-back shadow">
                    ...
                    <div class="card-header bg-warning rounded-top fw-bold  text-center">Mesin : {{ $molt2['mc'] }}
                    </div>
                    <div class="card-body py-2 px-0">
                        {{-- <h6 class="card-title text-center fs-6"></h6> --}}
            ...
            <div class="col-3">
                <div class="card card-rounded card-back shadow">
                    ...
                    <div class="card-header bg-warning rounded-top fw-bold  text-center">Mesin : {{ $molt3['mc'] }}
                    </div>
                    <div class="card-body py-2 px-0">
                        {{-- <h6 class="card-title text-center fs-6"></h6> --}}
            ...
            <div class="col-3">
                <div class="card card-rounded card-back shadow">
                    ...
                    <div class="card-header bg-warning rounded-top fw-bold  text-center">Mesin : {{ $molt4['mc'] }}
                    </div>
                    <div class="card-body py-2 px-0">
                        {{-- <h6 class="card-title text-center fs-6"></h6> --}}
                        <div class="card-content">
            ...
            <div class="col-3 mt-3">
                <div class="card card-rounded card-back shadow">
                    ...
                    <div class="card-header bg-warning rounded-top fw-bold  text-center">Mesin : {{ $molt5['mc'] }}
                    </div>
                    <div class="card-body py-2 px-0">
                        {{-- <h6 class="card-title text-center fs-6"></h6> --}}
                        <div class="card-content">
            ...
            <div class="col-3 mt-3">
                <div class="card card-rounded card-back shadow">
                    <div class="card-header bg-warning rounded-top fw-bold  text-center">Mesin : {{ $molt6['mc'] }}
                    </div>
                    <div class="card-body py-2 px-0">
                        {{-- <h6 class="card-title text-center fs-6"></h6> --}}
                        <div class="card-content">
